 ...
 * 
 * It only supports a millisecond precision. Any time more precise than that will be lost when parsing.
 * 
 * 
 */
public class NormalPlayTime {
	 ...
	 *             if the string representation could not be parsed
	 */
	...
	/**
	 * Gets the standard {@code seconds.fraction } representation for this object.
	 * 
	...
	/**
	 * Gets the standard {@code hh:mm:ss.fraction } representation for this object.
	 * 
	...
	private static class NPTParser {
		...
		private void assertCurrentIs(char c) throws ParseException {
			if (c != current) {
				throw new ParseException("Unexpected character at index " + currentIndex);
			}
		}
