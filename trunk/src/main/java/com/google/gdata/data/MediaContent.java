...
/**
 * The MediaContent class extends {@link OutOfLineContent} to add {@link MediaSource} handling for the content. This
 * class is used in contexts where a client or provider wants to provide access to the actual media data via a
 * MediaSource (instead of an href).
 * 
 * 
 */
