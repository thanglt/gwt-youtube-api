...
public class Namespaces {
	...
	/**
	 * Namespace for W3C's proposal for specifying geo-information. Please see
	 * the W3C document <a
	...
	public static final XmlNamespace W3C_GEO_NAMESPACE = new XmlNamespace(
			W3C_GEO_ALIAS, W3C_GEO);

	/**
	 * Namespace for the Geo RSS proposal for encoding geo information. Please
	 * see <a href="http://www.georss.org/">http://www.georss.org/</a> for more
	 * information.
	 */
	public static final String GEO_RSS = "http://www.georss.org/georss";
	public static final String GEO_RSS_ALIAS = "georss";

	public static final XmlNamespace GEO_RSS_NAMESPACE = new XmlNamespace(
			GEO_RSS_ALIAS, GEO_RSS);
