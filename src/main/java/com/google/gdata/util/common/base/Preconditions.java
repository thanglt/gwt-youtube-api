 ...
 * be even marked as {@link Nullable} -- yet the method will still throw an exception anyway, because that's what its
 * contract says to do.
 * 
 * 
 */
public final class Preconditions {
	 ...
	 *            the size of that array, list or string
	 * @throws IndexOutOfBoundsException
	 *             if either index is negative or is greater than {@code size}, or if {@code end} is less than {@code
	 *             start}
	 * @throws IllegalArgumentException
	 *             if {@code size} is negative
	 */
