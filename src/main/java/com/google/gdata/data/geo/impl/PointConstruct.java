...
public abstract class PointConstruct extends ValueConstruct implements Point {
	 ...
	 */
	public PointConstruct(String name) {
		super(name, null);
		setRequired(false);
	}
	 ...
	 */
	public PointConstruct(String name, Double lat, Double lon) {
		super(name, null);
	 ...
	 * setting those values. Will throw illegal argument exceptions if the
