...
public class YouTubeSearchResultPanel extends Composite {
			...
			if (this.description == null) {
				...
				if (categories != null && categories.size() > 0) {
					...
					while (categoryIterator.hasNext()) {
						...
						if (category != null && category.getScheme() != null && category.getScheme().indexOf("keywords") > -1 && category.getTerm() != null && category.getTerm().length() > 0) {
	...
	public void showResults(String textQuery) {
		showResults(textQuery, null);
	}
	
	public void showResults(String textQuery, QueryPage pageQuery) {
...
//			YouTubeEmbeddedPlayer youTubeEmbeddedPlayer = new YouTubeEmbeddedPlayer(youTubeSearchResult.getVideoId());
//			youTubeEmbeddedPlayer.setWidth("640px");
//			youTubeEmbeddedPlayer.setHeight("480px");
//			videoPanel.add(youTubeEmbeddedPlayer);
