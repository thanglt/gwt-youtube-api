...
public interface Point extends Extension {
	 ...
	 * lat and lon must be non-null, or both must be null. Implementations will
	 * throw an IllegalArgumentException if only one is null and one is not.
	 * They will also throw an IllegalArgumentException if either of the lat
	 * values is outside the valid range.
	 * 
	 * @param lat
	 ...
	 *             if either lat or lon values are invalid, or if one of them is
	 *             null and the other non-null.
	 */
