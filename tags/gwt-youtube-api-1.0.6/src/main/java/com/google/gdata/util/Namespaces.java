...
import com.google.gdata.util.xml.XmlNamespace;
...
public final class Namespaces {
	...
	public static final String OPEN_SEARCH_ALIAS = "openSearch";

	/**
	 * Atom Publishing Protocol (draft) namespace.
	 * 
	 * <p>
	 * Use this only when you are sure you want the draft version of the namespace. Use {@code getAtomPubNs().getUri()}
	 * when you want the atom pub namespace that should be used for the current version.
	 */
	 ...
	 * 
	 * <p>
	 * Use this only when you are sure you want the draft version of the namespace. Use {@link #getAtomPubNs()} when you
	 * want the atom pub namespace that should be used for the current version.
	 */
	public static final XmlNamespace atomPubDraftNs = new XmlNamespace("app", atomPubDraft);

	/**
	 * Atom Publishing Protocol (final) namespace.
	 * 
	 * <p>
	 * Use this only when you are sure you want the standard version of the namespace. Use {@code
	 * getAtomPubNs().getUri()} when you want the atom pub namespace that should be used for the current version.
	 */
	 ...
	 * 
	 * <p>
	 * Use this only when you are sure you want the standard version of the namespace. Use {@link #getAtomPubNs()} when
	 * you want the atom pub namespace that should be used for the current version.
	 */
	 ...
	 * Atom Publishing Protocol (draft) namespace.
	 * 
	 * @deprecated Use {@code getAtomPubNs().getUri()} instead. Use {@link #atomPubDraft} if you absolutely want the
	 *             draft app namespace and not the standard one.
	 */
	@Deprecated
	 ...
	 * Atom Publishing Protocol (draft) XML namespace.
	 * 
	 * @deprecated Use {@link #getAtomPubNs()} instead. Use {@link #atomPubDraftNs} if you absolutely want the draft app
	 *             namespace and not the standard one.
	 */
	@Deprecated
	 ...
	 * 
	 * <p>
	 * Use this only when you are sure you want the version 1.0 of the namespace. Use {@code getOpenSearchNs().getUri()}
	 * when you want the opensearch URI that should be used for the current version.
	 */
	 ...
	 * 
	 * <p>
	 * Use this only when you are sure you want the version 1.0 of the namespace. Use {@link #getOpenSearchNs()} when
	 * you want the opensearch URI that should be used for the current version.
	 */
	public static final XmlNamespace openSearch1_0Ns = new XmlNamespace("openSearch", openSearch1_0);

	/**
	 * Amazon OpenSearch 1.1 namespace.
	 * 
	 * <p>
	 * Use this only when you are sure you want the version 1.1 of the namespace. Use {@code getOpenSearchNs().getUri()}
	 * when you want the opensearch URI that should be used for the current version.
	 */
	 ...
	 * 
	 * @deprecated Use {@code getOpenSearchNs().getUri()} instead. Use {@link #openSearch1_0} if you absolutely want the
	 *             namespace of opensearch 1.0 and not 1.1.
	 */
	@Deprecated
	 ...
	 * 
	 * @deprecated Use {@link #getOpenSearchNs()} instead. Use {@link #openSearch1_0Ns} if you absolutely want the
	 *             namespace of opensearch 1.0.
	 */
	@Deprecated
	...
	/**
	 * Inflate a short name into a full GData URI using gPrefix (ending in "#"). Names that already look like URIs are
	 * left alone. For example, "foo" becomes "http://schemas.google.com/g/2005#foo".
	 * 
	 * @param name
	 *            the name
	 * @return the full URI
	...
	/**
	 * Deflate a full GData URI using gPrefix (with "#") into a short name if possible. Names that belong to a non-GData
	 * namespace are left alone. For example, "http://schemas.google.com/g/2005#foo" becomes "foo".
	 * 
	 * @param uri
	 *            the full URI
